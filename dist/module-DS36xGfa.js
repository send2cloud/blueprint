...
var K, v, Me, P, Ee, se, V = {}, Le = [], tt = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function M(t, e) {
...
function oe(t, e, n, r, o, i, s, l, c) {
  var u, a, p, h, f, _, m, b, $, y, B, C = e.type;
  ...
  try {
    e: if (typeof C == "function") {
      if (b = e.props, $ = (u = C.contextType) && r[u.__c], y = u ? $ ? $.props.value : u.__ : r, n.__c ? m = (a = e.__c = n.__c).__ = a.__E : ("prototype" in C && C.prototype.render ? e.__c = a = new C(b, y) : (e.__c = a = new S(b, y), a.constructor = C, a.render = it), $ && $.sub(a), a.props = b, a.state || (a.state = {}), a.context = y, a.__n = r, p = a.__d = !0, a.__h = []), a.__s == null && (a.__s = a.state), C.getDerivedStateFromProps != null && (a.__s == a.state && (a.__s = M({}, a.__s)), M(a.__s, C.getDerivedStateFromProps(b, a.__s))), h = a.props, f = a.state, p) C.getDerivedStateFromProps == null && a.componentWillMount != null && a.componentWillMount(), a.componentDidMount != null && a.__h.push(a.componentDidMount);
      else {
        if (C.getDerivedStateFromProps == null && b !== h && a.componentWillReceiveProps != null && a.componentWillReceiveProps(b, y), !a.__e && a.shouldComponentUpdate != null && a.shouldComponentUpdate(b, a.__s, y) === !1 || e.__v === n.__v) {
    ...
    } else i == null && e.__v === n.__v ? (e.__k = n.__k, e.__e = n.__e) : e.__e = rt(n.__e, e, n, r, o, i, s, c);
    (u = v.diffed) && u(e);
  } catch (H) {
...
function ft({ maxFrequentRows: t, perLine: e }) {
  if (!t) return [];
  k || (k = E.get("frequently"));
  let n = [];
  if (!k) {
...
function G(t, { caller: e } = {}) {
  return Y || (Y = new Promise((n) => {
    Ne = n;
  })), t ? pt(t) : e && !We && console.warn(`\`${e}\` requires data to be initialized first. Promise will be pending until \`init\` is called.`), Y;
}
async function pt(t) {
  We = !0;
  ...
  for (; s--; ) {
    ...
    for (; a--; ) {
      ...
      if (i && c.id == "flags" && !mt.includes(h.id)) {
        f();
        continue;
      }
      if (!h.search) {
...
async function bt(t, { maxResults: e, caller: n } = {}) {
...
async function kt(t = 1) {
  for (let e in [
    ...Array(t).keys()
  ]) await new Promise(requestAnimationFrame);
}
function Ge(t, { skinIndex: e = 0 } = {}) {
...
const xt = typeof window < "u" && window.HTMLElement ? window.HTMLElement : Object;
class Xe extends xt {
...
x(Ye, "Props", Je);
typeof customElements < "u" && !customElements.get("em-emoji") && customElements.define("em-emoji", Ye);
...
(T.prototype = new S()).__e = function(t) {
  var e = this, n = Ze(e.__v), r = e.o.get(t);
...
v.event = function(t) {
  return xe && (t = xe(t)), t.persist = Rt, t.isPropagationStopped = Pt, t.isDefaultPrevented = Bt, t.nativeEvent = t;
};
var Ce = {
  configurable: !0,
  get: function() {
...
v.vnode = function(t) {
  ...
  if (typeof e == "string") {
    ...
    })), t.props = r, n.class != n.className && (Ce.enumerable = "className" in n, n.className != null && (r.class = n.className), Object.defineProperty(r, "className", Ce));
  }
  t.$$typeof = Mt, Se && Se(t);
};
var je = v.__r;
...
class It extends S {
  ...
  renderEmojiButton(e, { pos: n, posinset: r, grid: o }) {
    const i = this.props.emojiButtonSize, s = this.state.tempSkin || this.state.skin, c = (e.skins[s - 1] || e.skins[0]).native, u = $t(this.state.pos, n), a = n.concat(e.id).join("");
  ...
  constructor(e) {
    super(), x(this, "darkMediaCallback", () => {
      this.props.theme == "auto" && this.setState({
        theme: this.darkMedia.matches ? "dark" : "light"
      });
    }), x(this, "handleClickOutside", (n) => {
    ...
    }), x(this, "handleSearchInput", async () => {
    ...
    }), x(this, "handleCategoryClick", ({ category: n, i: r }) => {
      this.scrollTo(r == 0 ? {
        row: -1
      } : {
        categoryId: n.id
...
class Qe extends Ct {
  ...
  constructor(e) {
    super(e, {
      styles: /* @__PURE__ */ ze(et)
    });
  }
}
x(Qe, "Props", z);
typeof customElements < "u" && !customElements.get("em-emoji-picker") && customElements.define("em-emoji-picker", Qe);
var et = {};
et = `:host {
  width: min-content;
  height: 435px;
